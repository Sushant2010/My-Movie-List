...
public class UpcomingMovies extends AppCompatActivity implements  UpcomingMoviesPosterGridFragment.OnMovieSelectedListener {

    static final String TAG = UpcomingMovies.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.upcoming_main);
...
//            this.startActivity(intent);
    ...
    private void toggleFavorite() {
        ...
        if (mTwoPaneMode && !mIsFavorite) {
            UpcomingMoviesPosterGridFragment gridFragment = (UpcomingMoviesPosterGridFragment) getSupportFragmentManager().findFragmentById(R.id.upcoming_fragment_grid);
