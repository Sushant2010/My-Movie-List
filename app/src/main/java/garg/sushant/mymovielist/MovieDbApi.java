...
import garg.sushant.mymovielist.rest.MovieService;
import garg.sushant.mymovielist.rest.ReviewResponse;
import garg.sushant.mymovielist.rest.VideoResponse;
...
public class MovieDbApi {
    ...
    public void requestInTheatresMovies(@Nullable final MovieListListener listener) {

        getMovieService().fetchInTheatresMovies(sApiKey, new Callback<MovieListResponse>() {
            @Override
            public void success(MovieListResponse response, Response httpResponse) {
                Log.d(TAG, "Number of movies found: " + response.getMovies().size());
                if (listener != null) {
    ...
    public void requestInTheatresMovies(int page, @Nullable final MovieListListener listener) {

        getMovieService().fetchInTheatresMovies(sApiKey, page, new Callback<MovieListResponse>() {
            @Override
            public void success(MovieListResponse response, Response httpResponse) {
                Log.d(TAG, "Number of movies found: " + response.getMovies().size());
                if (listener != null) {
    ...
    public void requestUpcomingMovies(@Nullable final MovieListListener listener) {

        getMovieService().fetchUpcomingMovies(sApiKey, new Callback<MovieListResponse>() {
            @Override
            public void success(MovieListResponse response, Response httpResponse) {
                Log.d(TAG, "Number of movies found: " + response.getMovies().size());
                if (listener != null) {
    ...
    public void requestUpcomingMovies(int page, @Nullable final MovieListListener listener) {
        ...
        getMovieService().fetchUpcomingMovies(sApiKey, page, new Callback<MovieListResponse>() {
            @Override
            public void success(MovieListResponse response, Response httpResponse) {
                Log.d(TAG, "Number of movies found: " + response.getMovies().size());
                if (listener != null) {
