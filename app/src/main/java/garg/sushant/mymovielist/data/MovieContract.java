package garg.sushant.mymovielist.data;
...
public class MovieContract {
    ...
    public static final String CONTENT_AUTHORITY = "garg.sushant.mymovielist";
    ...
    public static class MovieEntry implements BaseColumns {
        ...
        public static final String SELECT_WATCHED = MovieEntry.TABLE_NAME + "." + MovieEntry.COLUMN_WATCHED + " = 1 ";
        public static final String SELECT_TOWATCH = MovieEntry.TABLE_NAME + "." + MovieEntry.COLUMN_TOWATCH + " = 1 ";
        ...
        public static final String COLUMN_TOWATCH = "towatch";
