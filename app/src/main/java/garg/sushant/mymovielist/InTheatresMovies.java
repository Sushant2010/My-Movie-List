...
public class InTheatresMovies extends AppCompatActivity implements  InTheatresMoviePosterGridFragment.OnMovieSelectedListener {

    static final String TAG = InTheatresMovies.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.intheatres_main);
        ButterKnife.bind(this);

        Toolbar toolbar = (Toolbar) findViewById(R.id.toolbar);
        toolbar.setTitle("In Theatres");
//        if (toolbar != null) {
...
//            this.startActivity(intent);
    ...
    private void toggleFavorite() {
        ...
        if (mTwoPaneMode && !mIsFavorite) {
            InTheatresMoviePosterGridFragment gridFragment = (InTheatresMoviePosterGridFragment) getSupportFragmentManager().findFragmentById(R.id.intheatres_fragment_grid);
