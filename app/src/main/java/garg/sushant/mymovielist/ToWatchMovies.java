...
public class ToWatchMovies extends AppCompatActivity implements ToWatchMoviePosterGridFragment.OnMovieSelectedListener {


    static final String TAG = ToWatchMovies.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.towatch_main);
...
//            this.startActivity(intent);
    ...
    private void toggleToWatch() {
        ...
        if (mTwoPaneMode && !mIsToWatch) {
            ...
            ToWatchMoviePosterGridFragment gridFragment = (ToWatchMoviePosterGridFragment) getSupportFragmentManager().findFragmentById(R.id.towatch_fragment_grid);
