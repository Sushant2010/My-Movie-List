...
public class FavoriteMovies extends AppCompatActivity implements  FavoriteMoviePosterGridFragment.OnMovieSelectedListener {

    static final String TAG = FavoriteMovies.class.getSimpleName();
